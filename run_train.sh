...
--batch_size 2 --iters_per_update 4 --scheduler_step_size 10  --cvo_loss  --disp_in_loss --min_depth 3 --num_layers 50 --cvo_loss_dense --dense_flat_grid --supervised_by_gt_depth --num_workers 6 #\
